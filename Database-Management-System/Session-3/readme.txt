SCHEMA USED FOR DBMS ASSIGNMENT-3 IS:

product( product_id [primary_key], product_name, price, stock, description, date_added, last_updated, is_active )
...
product_order( order_id [primary_key], address_id [foreign_key], date, user_id [foreign_key] )

user( user_id [primary_key], name, type, registration_date, email )
