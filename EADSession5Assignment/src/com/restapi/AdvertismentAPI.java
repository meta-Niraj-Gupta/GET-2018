...
public class AdvertismentAPI{
	...
	public Response addAdvertisement(Advertisement advertisement) throws IOException{
		Response response;
		AdvertismentDAO advertisementDAO = null;
		try{
			advertisementDAO = new AdvertismentDAO();
	...
	@Path("update")
	@Consumes(MediaType.APPLICATION_JSON)
	public Response setTitle(Advertisement advertisement) throws IOException{
		Response response;
		AdvertismentDAO advertisementDAO;
		try{
			advertisementDAO = new AdvertismentDAO();
