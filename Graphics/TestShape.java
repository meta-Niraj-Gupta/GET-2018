...
public class TestShape{
	...
	public void circle_HappyFlow(){
		Shape circle = ShapeFactory.createShape(ShapeType.CIRCLE, new Point(1, 1), Arrays.asList(4));
	...
	public void addShape_Exception_WhenTheGivenPointLieOutsideTheScreen(){
		...
		Screen screen = new Screen(100, 100);
		Shape shape1 = ShapeFactory.createShape(ShapeType.RECTANGLE, new Point(120, 1), Arrays.asList(4, 2));
		screen.addShape(shape1);
	}
	...
	public void deleteShapeType_HappyFlow(){
		...
		Shape shape2 = ShapeFactory.createShape(ShapeType.RECTANGLE, new Point(1, 3), Arrays.asList(5, 2));
	...
	public void sortByArea_HappyFlow(){
		...
		Shape shape2 = ShapeFactory.createShape(ShapeType.SQUARE, new Point(1, 1), Arrays.asList(2));
		screen.addShape(shape2);
	...
	public void sortByOriginDistance_HappyFlow(){
		...
		Shape shape2 = ShapeFactory.createShape(ShapeType.SQUARE, new Point(2, 1), Arrays.asList(2));
		screen.addShape(shape2);

		Shape shape3 = ShapeFactory.createShape(ShapeType.CIRCLE, new Point(0, 0), Arrays.asList(4));
