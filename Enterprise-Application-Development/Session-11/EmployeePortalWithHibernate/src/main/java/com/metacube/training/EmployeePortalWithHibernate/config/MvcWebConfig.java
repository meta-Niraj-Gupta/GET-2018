package com.metacube.training.EmployeePortalWithHibernate.config;
...
import com.metacube.training.EmployeePortalWithHibernate.model.UserRoles;
...
public class MvcWebConfig implements WebMvcConfigurer {
	...
	public LocalSessionFactoryBean getSessionFactory() {
		...
		factoryBean.setAnnotatedClasses(Project.class, Skill.class,
				Employee.class, Address.class, EmployeeSkills.class, Job.class,
				JobDetails.class, UserRoles.class);
