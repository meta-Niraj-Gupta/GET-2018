...
public class TriangleServiceLocator extends org.apache.axis.client.Service implements com.service.TriangleService {
    ...
    private java.lang.String Triangle_address = "http://localhost:8080/EADSession6/services/Triangle";
    ...
    public com.service.Triangle getTriangle() throws javax.xml.rpc.ServiceException {
    ...
    public com.service.Triangle getTriangle(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.service.TriangleSoapBindingStub _stub = new com.service.TriangleSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.service.Triangle.class.isAssignableFrom(serviceEndpointInterface)) {
                com.service.TriangleSoapBindingStub _stub = new com.service.TriangleSoapBindingStub(new java.net.URL(Triangle_address), this);
                _stub.setPortName(getTriangleWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://service.com", "TriangleService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://service.com", "Triangle"));
        }
