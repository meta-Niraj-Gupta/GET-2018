...
<jsp:useBean id="sampleTriangleProxyid" scope="session" class="com.service.TriangleProxy" />
<%
...
case 10:
        gotMethod = true;
        com.service.Triangle getTriangle10mtemp = sampleTriangleProxyid.getTriangle();
...
case 13:
        ...
        double calculateArea13mtemp = sampleTriangleProxyid.calculateArea(side1_1idTemp,side2_2idTemp,side3_3idTemp);
