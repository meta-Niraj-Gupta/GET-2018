...
public class AdvertismentDAO{
	...
	public void addAdvertisment(Advetisment advertisement) throws SQLException{
	...
	public Advetisment getAdvertisment(int id) throws SQLException{
		Advetisment advertisement = null;
		PreparedStatement statement = connection
				.prepareStatement(DatabaseQuery.SELECT_FROM_ADVERTISMENT);
		statement.setInt(1, id);
		ResultSet resultSet = statement.executeQuery();
		if(resultSet.next()){
			advertisement = new Advetisment();
	...
	public List<Advetisment> getAllAdvertisment(int id) throws SQLException{
		List<Advetisment> advertisements = new ArrayList<>();
		PreparedStatement statement = connection.prepareStatement(DatabaseQuery.SELECT_ALL_FROM_ADVERTISMENT_HAVING_ID);
		statement.setInt(1, id);
		ResultSet resultSet = statement.executeQuery();
		while(resultSet.next()){
			Advetisment advertisement = new Advetisment();
			advertisement.setCategoryId(resultSet.getInt("category_id"));
			advertisement.setId(resultSet.getInt("id"));
	...
	public List<Advetisment> getAll() throws SQLException{
		List<Advetisment> advertisements = new ArrayList<>();
