...
import com.metacube.training.EmployeePortalWithSecurity.mapper.ProjectMapper;
...
public class ProjectDAOImpl implements ProjectDAO {
	...
	private final String SQL_FIND_PROJECT_BY_NAME = "select * from project where description = ?";
	...
	public Project getProjectByName(String input) {
		return jdbcTemplate.queryForObject(SQL_FIND_PROJECT_BY_NAME,
				new Object[] { input }, new ProjectMapper());
	}
}