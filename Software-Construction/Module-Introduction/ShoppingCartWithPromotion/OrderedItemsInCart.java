...
public class OrderedItemsInCart {
	...
	private FixedProductPromotion fixedProductPromotion;
	private FixedOrderPromotion fixedOrderPromotion;
	 ...
	 */
	public void addProductToCart(int productId, int quantity) throws ItemNotFoundException{
		...
		if(product.containsKey(productId)){
			...
			throw new ItemNotFoundException("The product " + product.get(productId).getProductName() + " is not in the stock");
		}
	 ...
	 * @throws ItemNotFoundError 
	 */
	public void editProductQuantity(int productId, int quantity) throws ItemNotFoundException{
		if(shoppingCart.containsKey(productId)){
	...
	public void generateBill(){
		...
		for(int id : shoppingCart.keySet()){
			Item item = product.get(id);
			double itemCost = FixedProductPromotion.applyPromotion(fixedProductPromotion, item.getProductCost()) * shoppingCart.get(id);
		...
		double netCost = FixedOrderPromotion.applyPromotion(fixedOrderPromotion, totalShoppingCost);
		System.out.println("\nTotal value added to cart is: " + totalShoppingCost);
		System.out.println("Total cost after applying promo code is " + netCost);
	}
	
	public void setFixedOrderPromotion(FixedOrderPromotion fixedOrderPromotion){
		this.fixedOrderPromotion=fixedOrderPromotion;
	}
	
	public void setFixedProductPromotion(FixedProductPromotion fixedProductPromotion){
		this.fixedProductPromotion=fixedProductPromotion;
	}
}
